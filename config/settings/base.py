...
LOCAL_APPS = [
    "badge_earning.users.apps.UsersConfig",
    # Your stuff: custom apps go here,
    "badge_earning.badges.apps.BadgesConfig",
    "badge_earning.api.apps.ApiConfig",
]
...
MIGRATION_MODULES = {"sites": "badge_earning.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "badge_earning.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Sokunbi Taiwo""", "sokunbitaiwo82@gmail.com")]
